...
--
-- Temporary view structure for view `recorrido_cr`
--

DROP TABLE IF EXISTS `recorrido_cr`;
/*!50001 DROP VIEW IF EXISTS `recorrido_cr`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `recorrido_cr` AS SELECT 
 1 AS `espera_gen * numero_buses`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `recorrido_tot`
--

DROP TABLE IF EXISTS `recorrido_tot`;
/*!50001 DROP VIEW IF EXISTS `recorrido_tot`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `recorrido_tot` AS SELECT 
 1 AS `espera_gen * numero_buses`*/;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `tiempo` (
  ...
  `id_ruta` int(11) DEFAULT NULL,
  `camion` varchar(60) DEFAULT NULL,
  `espera_gen` float DEFAULT NULL,
  `espera_fin` float DEFAULT NULL,
  `numero_buses` float DEFAULT NULL,
...
INSERT INTO `tiempo` VALUES (NULL,NULL,NULL,'Tarahumara Directo',6,15,NULL),(NULL,NULL,NULL,'Fco. Portillo (Directo)',40,55,NULL),(NULL,NULL,NULL,'Infonavit Directo',20,50,NULL),(NULL,NULL,NULL,'Camino Real',8,20,NULL),(NULL,NULL,NULL,'Tarahumara Directo',6,15,10),(NULL,NULL,NULL,'Fco. Portillo Directo',40,55,3),(NULL,NULL,NULL,'Infonavit (Directo)',20,50,3),(NULL,NULL,NULL,'Camino Real. ',8,20,6);
...
--
-- Final view structure for view `recorrido_cr`
--
...
/*!50001 VIEW `recorrido_cr` AS select (`tiempo`.`espera_gen` * `tiempo`.`numero_buses`) AS `espera_gen * numero_buses` from `tiempo` where (`tiempo`.`numero_buses` = '6') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `recorrido_tot`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `recorrido_tot` AS select (`tiempo`.`espera_gen` * `tiempo`.`numero_buses`) AS `espera_gen * numero_buses` from `tiempo` where (`tiempo`.`numero_buses` = '6') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-04-21  4:12:05
